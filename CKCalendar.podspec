#
# Be sure to run `pod spec lint CKCalendar.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  s.author   = { 'Luis Felipe' => 'solanoluz@gmail.com' }
  ...
  s.description = 'An optional longer description of CKCalendar.'
